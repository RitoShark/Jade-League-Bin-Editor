...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            app_commands::store_font,
            app_commands::get_stored_fonts,
            app_commands::get_font_data_url,
            app_commands::delete_font,
            ...
            mesh_commands::read_skl_skeleton,
            mesh_commands::wad_read_skl_skeleton,
            mesh_commands::wad_find_sibling_skl,
            mesh_commands::find_skin_bin_for_skn,
            mesh_commands::wad_read_skn_animations,
